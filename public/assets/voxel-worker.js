(function () {
  'use strict';
  var F = (() => {
    var r = self.location ? self.location.href.split('/').slice(0, -1).join('/') : '';
    return function (e = {}) {
      var e;
      e || (e = typeof e < 'u' ? e : {});
      var c, u;
      ...
      (o = self.location.href),
        r && (o = r),
        o.indexOf('blob:') !== 0 ? (o = o.substr(0, o.replace(/[?#].*/, '').lastIndexOf('/') + 1)) : (o = ''),
        (w = (t) => {
      ...
      Object.assign(e, p), (p = null), e.arguments && e.arguments, e.thisProgram && e.thisProgram, e.quit && e.quit;
      var m;
      e.wasmBinary && (m = e.wasmBinary), e.noExitRuntime, typeof WebAssembly != 'object' && h('no native wasm support detected');
      var I,
        H = !1,
        b,
        P,
      ...
      var M = [],
        ...
        C = [];
      function K() {
        if (e.preRun) for (typeof e.preRun == 'function' && (e.preRun = [e.preRun]); e.preRun.length; ) J(e.preRun.shift());
        U(M);
      }
      function X() {
        U(W);
      ...
      function $() {
        if (e.postRun) for (typeof e.postRun == 'function' && (e.postRun = [e.postRun]); e.postRun.length; ) Y(e.postRun.shift());
        U(C);
      }
      function J(t) {
        M.unshift(t);
      ...
      function ee(t) {
        if ((l--, e.monitorRunDependencies && e.monitorRunDependencies(l), l == 0 && _)) {
          var n = _;
          (_ = null), n();
        }
      }
      function h(t) {
        e.onAbort && e.onAbort(t), (t = 'Aborted(' + t + ')'), d(t), (H = !0), (t += '. Build with -sASSERTIONS for more info.');
      ...
      var f;
      e.locateFile ? ((f = 'libvoxel.wasm'), T(f) || (f = G(f))) : (f = new URL('./libvoxel.1ba27f06.wasm', self.location).href);
      function x(t) {
        try {
      ...
      function ie(t, n, a, i) {
        return !t && typeof WebAssembly.instantiateStreaming == 'function' && !T(n) && typeof fetch == 'function'
          ? fetch(n, { credentials: 'same-origin' }).then((N) => {
              ...
              return g.then(i, function (fe) {
                return d('wasm streaming compile failed: ' + fe), d('falling back to ArrayBuffer instantiation'), D(n, a, i);
              });
            })
          : D(n, a, i);
      }
      ...
      function V() {
        if (l > 0 || (K(), l > 0)) return;
        function t() {
          y || ((y = !0), (e.calledRun = !0), !H && (X(), c(e), e.onRuntimeInitialized && e.onRuntimeInitialized(), $()));
        }
        e.setStatus
          ? (e.setStatus('Running...'),
            setTimeout(function () {
  ...
  class q {
    ...
    generate(s, e) {
      ...
      const c = this._module.getValue(this._pointCount, 'i32'),
        ...
        p = new Uint8Array(this._module.HEAPU8.subarray(this._positions, this._positions + u * 12).slice()),
        R = new Uint8Array(this._module.HEAPU8.subarray(this._uvs, this._uvs + u * 8).slice()),
        o = new Uint32Array(this._module.HEAPU8.subarray(this._indices, this._indices + u * 24).slice().buffer);
      return {
        point_count: c,
        face_count: u,
        positions: p,
